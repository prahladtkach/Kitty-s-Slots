// Kitty's Slots Deluxe · versión pública (v2.58) · Pistas afinadas: la 2da pista de Katto ahora insinúa el código en vez de dictarlo, y se limpiaron un par de emojis de los diálogos de pista. Cache busting → 2.58.
  /* ============================================================
  ...
  function applySave(d){
    ...
    if(typeof state.limboUnlocked!=='boolean') state.limboUnlocked=true; if(typeof state.pibble!=='boolean') state.pibble=false;
