// Kitty's Slots Deluxe · versión pública (v2.43) · FIX: llegar al tope ahora desbloquea el Limbo (antes solo se desbloqueaba al quebrar, así que llegar al tope sin quebrar dejaba el botón en 🔒). El desbloqueo se guarda automáticamente. Cache busting → 2.43.
  /* ============================================================
