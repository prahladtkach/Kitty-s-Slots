// Kitty's Slots Deluxe · versión pública (v2.42) · Paytable restaurada a la v2.13 (validada con Monte Carlo): 2 símbolos iguales vuelven a pagar (PAIR2), triples más bajos (PAY3 v2.13), 1 cereza paga x1.5. Visualización en formato 2 iguales / 3 iguales. RTP ~125% y paga el 54% de los giros (más premios + menos inflación que antes). Cache busting → 2.42.
  /* ============================================================
