// Kitty's Slots Deluxe · DESARROLLO (v1.1-dev) · para TESTEAR, no subir
  ...
  const HELP_TOPICS=[ {id:'intro',label:'🎮 Cómo jugar',text:TXT_INTRO}, {id:'cuenta',label:'👤 Cuenta y progreso',text:TXT_CUENTA}, {id:'bank',label:'🏦 Banco y préstamos',text:TXT_BANK} ];
